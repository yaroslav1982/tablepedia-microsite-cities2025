...
var i1=xbig / xsmall;
//var i2=Math.floor(i1+0.5);
var i2=Math.floor(i1);
var i3=i2*xsmall;
var i4=i3.toFixed(10);
return i4;
}
...
var iDiv = vStep;
var nDiv=(y2-y1)/vStep;
var x1n=0;

for (let i = 0; i < nDiv; i++) {
	x1n=y1+vStep*i;
	sSeries=NUMBERfloat(x1n, vStep);
        result.push(sSeries);
    }

for (let x = y1; x < y2; x += vStep) {
	sSeries=NUMBERfloat(x, vStep);
//        result.push(sSeries);
    }

//var i1=parseFloat(sSeries);
//var s1=NUMBERfloat(i1);
//var i2=y2;
//var s2=NUMBERfloat(i2);

//var propo=i1/i2;
//if (propo>1) propo=1/propo;
////////////////////////if (propo>0.99) { result.push(y2);}
